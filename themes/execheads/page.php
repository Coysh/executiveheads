	      ...
	      <?php if(!empty($links) && is_array($links)): ?>
		      <div class="gm-top--2 gm-bottom--2">
		      	<?php foreach ($links as $link): ?>
		        	<p><a <?php if(!empty($link['open_link_in_new_window'])): ?>target="_blank" rel="noopener noreferrer"<?php endif; ?> href="<?php echo esc_url($link['link_url']); ?>" class="white-text uppercase">> <?php echo esc_html($link['link_text']); ?></a></p>
	        	<?php endforeach; ?>
		      </div>
	  	  <?php endif; ?>
