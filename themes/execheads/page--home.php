...
<div class="hero hero--home <?php if(get_field('show_triangles') == 1): ?>hero--with-triangles<?php endif; ?>"<?php if($hero_image_url): ?> style="background-image:url(<?php echo esc_url($hero_image_url); ?>);"<?php endif; ?>>
	<div class="responsive-embed widescreen">
		<iframe src="https://player.vimeo.com/video/384510938?background=1" width="640" height="360" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
	</div>
	<div class="hero__content row align-middle">
	  <div class="row">
	    <div class="column small-12 medium-10 large-6">
      	  <?php if(have_rows('hero_text_slider')): ?>
      	  	<div class="hero__slider slick" data-slick='{"adaptiveHeight": true , "fade": true,"slidesToShow": 1, "arrows": false, "dots": false, "autoplay": false, "autoplaySpeed": 5000 }'>
			    <?php while(have_rows('hero_text_slider')): the_row(); ?>
				  <div class="hero__slider__text" style="max-width: 450px;">
					  <h1 class="hero__h1"><?php echo esc_html(get_sub_field('hero_title')); ?></h1>
					  <?php if(get_sub_field('hero_text')): ?>
						<?php echo wp_kses_post(get_sub_field('hero_text')); ?>
		      	  	  <?php endif; ?>
	      	  	  </div>
			    <?php endwhile; ?>
		    </div>
		  <?php elseif($hero_title || $hero_preview): ?>
			<div class="hero__slider__text" style="max-width: 450px;">
			  ...
			  <?php endif; ?>
			  <?php if($hero_preview): ?>
				<p><?php echo nl2br(esc_html($hero_preview)); ?></p>
			  <?php endif; ?>
			</div>
		  <?php endif; ?>
...
<div class="row shrink-width gm-top--4 gm-bottom--4">
	<div class="column small-12">
	  <h4 class="underline gm-bottom--2 underline--black">Latest blogs</h4>
	</div>
	<div class="column small-12">
	  <div class="row">
		    ...
		    <div class="column small-12 large-6">
		      <div class="row">
		        <div class="column small-12 large-10">
		          <p><a class="blue-text" href="<?php the_permalink(); ?>"><strong><?php the_title(); ?></strong></a></p>
		          <p><?php the_excerpt(); ?></p>
	...
	<div class="column small-12 gm-top--2">
	  <a href="/knowledge-hub/" class="button button--green">Visit the knowledge hub</a>
	</div>
</div>
